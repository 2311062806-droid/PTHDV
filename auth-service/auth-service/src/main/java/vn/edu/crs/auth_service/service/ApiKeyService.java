...
public class ApiKeyService {
    ...
    // SecureRandom: sinh so ngau nhien an toan ve mat ma hoc - bat buoc khi sinh
    // gia tri dong vai tro bi mat (key, token), khac voi Random thuong co the bi du doan truoc
     ...
     * Dung boi endpoint noi bo ma api-gateway se goi sang (xem InternalApiKeyController).
     */
