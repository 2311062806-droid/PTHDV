...
export default function RegisterCoursePage() {
    ...
    const handleRegister = async (course: Course) => {
        ...
        try {
            ...
            // Tải lại danh sách để cập nhật số chỗ còn lại ngay sau khi đăng ký
            refetch();
        } catch (err) {
            // LƯU Ý: lỗi có thể đến từ registration-service (vd: "đã đăng ký rồi")
            // hoặc lan truyền từ course-service (vd: "hết chỗ") - Frontend KHÔNG cần
            // phân biệt nguồn gốc, chỉ cần đọc đúng trường "message" trong JSON trả về.
